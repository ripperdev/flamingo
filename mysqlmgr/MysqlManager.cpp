...
CMysqlManager::CMysqlManager() {
    ...
    // 1. t_user
    {
        ...
        info.m_mapField["f_customfacefmt"] = {"f_customfacefmt", "varchar(6) DEFAULT NULL COMMENT '自定义头像格式'",
                                              "varchar(6)"};
        ...
        info.m_mapField["f_update_time"] = {"f_update_time",
    ...
    // 2. t_user_relationship 
    {
        ...
        info.m_mapField["f_user1_teamname"] = {"f_user1_teamname",
                                               "VARCHAR(32) NOT NULL DEFAULT 'My Friends' COMMENT '用户2在用户1的好友分组名称'",
                                               "VARCHAR(32)"};
        info.m_mapField["f_user2_teamname"] = {"f_user2_teamname",
                                               "VARCHAR(32) NOT NULL DEFAULT 'My Friends' COMMENT '用户1在用户2的好友分组名称'",
                                               "VARCHAR(32)"};
    ...
    // 3. t_chatmsg
    {
        ...
        chat.m_mapField["f_create_time"] = {"f_create_time",
                                            "timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'",
                                            "timestamp"};
...
bool CMysqlManager::checkTable(const STableInfo &table) {
    ...
    } else // 检查字段是否匹配， 暂时只检查是否存在， 还需进一步看类型是否需要修改
    {
        ...
        for (auto it = table.m_mapField.begin();
